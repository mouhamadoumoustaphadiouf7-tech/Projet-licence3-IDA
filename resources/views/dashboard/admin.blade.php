    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white/5 rounded-xl border border-white/10 p-6 flex items-center gap-4">
                <div class="h-12 w-12 rounded-lg bg-violet-500/10 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-violet-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="bg-white/5 rounded-xl border border-white/10 p-6 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-400">Total voitures</p>
                    <p class="text-2xl font-bold text-white">{{ \App\Models\Voiture::count() }}</p>
                </div>
            </div>
            ...
            <div class="bg-white/5 rounded-xl border border-white/10 p-6 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-400">Total réservations</p>
                    <p class="text-2xl font-bold text-white">{{ \App\Models\Reservation::count() }}</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <a href="/voitures" class="group bg-white/5 rounded-xl border border-white/10 p-6 hover:bg-white/[0.08] hover:border-indigo-400/30 transition flex items-start gap-4">
                ...
                <div>
                    <h4 class="font-semibold text-white group-hover:text-indigo-300 transition">Voir toutes les voitures</h4>
                    <p class="text-sm text-gray-400 mt-1">Gérer le catalogue de voitures</p>
                </div>
            </a>
            ...
            <a href="/mes-reservations" class="group bg-white/5 rounded-xl border border-white/10 p-6 hover:bg-white/[0.08] hover:border-indigo-400/30 transition flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1">Consulter toutes les réservations</p>
                </div>
            </a>

            <a href="/users" class="group bg-white/5 rounded-xl border border-white/10 p-6 hover:bg-white/[0.08] hover:border-indigo-400/30 transition flex items-start gap-4">
                <div class="h-11 w-11 rounded-lg bg-violet-500/10 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-violet-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="9" cy="8" r="3.5"/>
                        <path d="M2.5 19c0-3.3 2.9-6 6.5-6s6.5 2.7 6.5 6" stroke-linecap="round"/>
                        <path d="M16 4.3a3.5 3.5 0 0 1 0 6.9M21.5 19c0-2.8-2.1-5.2-5-5.8" stroke-linecap="round"/>
                    </svg>
                ...
                <div>
                    <h4 class="font-semibold text-white group-hover:text-indigo-300 transition">Gérer les utilisateurs</h4>
                    <p class="text-sm text-gray-400 mt-1">Ajouter, modifier ou supprimer des comptes</p>
                </div>
            </a>
