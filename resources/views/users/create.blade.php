...
@section('content')
    ...
    <div class="max-w-2xl mx-auto px-6 py-8">
        ...
        <!-- HEADER -->
        <h2 class="text-3xl font-bold text-white mb-6">Ajouter un utilisateur</h2>
        ...
        <form method="POST" action="/users"
            ...
            <div>
                ...
                <input type="text" name="name" placeholder="Ex : Awa Diop" value="{{ old('name') }}"
            ...
            <div>
                ...
                <select name="role"
                    ...
                    <option value="vendeur" class="bg-[#0B0F1A]" @selected(old('role') === 'vendeur')>Vendeur</option>
                </select>
            </div>
